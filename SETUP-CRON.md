...
**`https://scale-ag.github.io/dash-drvinicius/`**
...
- Repository access: **Only select repositories → `dash-drvinicius`**
...
### URL
```
https://api.github.com/repos/scale-ag/dash-drvinicius/actions/workflows/deploy.yml/dispatches
```
